...
type ImportTab = "catadores" | "entidades" | "diagnostico";
...
export const Route = createFileRoute("/_authenticated/admin/importar")({
  ...
  validateSearch: (s: Record<string, unknown>) => ({
    tab: s.tab === "entidades" || s.tab === "diagnostico" ? (s.tab as ImportTab) : undefined,
  }),
  ...
  return (
    <div className="mb-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          Envie planilha CSV ou XLSX. Cada linha vira uma associação, cooperativa ou coletivo.
        </p>
      </div>
